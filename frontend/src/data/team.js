...
export const faculties = [
  {
    ...
    designation: 'Faculty Advisor & Mentor',
    role: 'Faculty Advisor & Mentor',
    domain: 'Computer Engineering',
    bio: 'Guiding student tech initiatives, research incubation, and Google Developer Groups on Campus programs at PCCOE.',
    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop',
    linkedinUrl: '#',
    githubUrl: '#',
    social: { linkedin: '#', github: '#', twitter: '#', email: '#' },
    skills: ['Academic Guidance', 'Student Mentorship', 'Research', 'Tech Innovation'],
  },
  {
    id: 102,
    ...
    bio: 'Facilitating student-industry collaborations, hackathon incubations, and cloud technology study jams on campus.',
    image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop',
    linkedinUrl: '#',
    githubUrl: '#',
    social: { linkedin: '#', github: '#', twitter: '#', email: '#' },
    skills: ['Cloud Computing', 'Event Coordination', 'Tech Outreach', 'Curriculum'],
  },
];
